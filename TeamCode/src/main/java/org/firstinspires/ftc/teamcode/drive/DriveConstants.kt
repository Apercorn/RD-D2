...
object DriveConstants {
   ...
   */
  @JvmField var RUN_USING_ENCODER = true
   ...
   */
  @JvmField var WHEEL_RADIUS = 3.54331
   ...
   */
  @JvmField var GEAR_RATIO = 1.0 / 20.0
   ...
   */
  @JvmField var LOGO_FACING_DIR = RevHubOrientationOnRobot.LogoFacingDirection.UP
  @JvmField var USB_FACING_DIR = RevHubOrientationOnRobot.UsbFacingDirection.FORWARD

  @JvmField var LEFT_DIRECTION = DcMotorSimple.Direction.REVERSE
  @JvmField var RIGHT_DIRECTION = DcMotorSimple.Direction.FORWARD
